 ...
 */
export const TECHNICAL_PROMPT = `Классификация и отбор уже выполнены системой — НЕ переклассифицируй и не пересчитывай:
- У каждой компетенции в данных заданы zoneVsOthers (зона к совокупной оценке окружения) и zoneByGroup (зона к каждой группе): BLIND_SPOT — самооценка выше группы на 0,6 и более; HIDDEN_POTENTIAL — самооценка ниже на 0,6 и более; CONSENSUS — иначе.
