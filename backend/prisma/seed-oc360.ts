...
// Утверждённая шкала компании (формулировки методики v1.3); 0 — служебный пункт
// «нет наблюдения», в расчёты не входит (NO_OBSERVATION_SCORE в oc360/results/analytics.ts)
...
const scalePoints = [
  ...
  { value: 2, label: 'Иногда проявлялось, но нестабильно' },
  { value: 3, label: 'Чаще всего проявляется, есть отдельные исключения' },
  { value: 4, label: 'Стабильно и предсказуемо проявляется в разных ситуациях' },
];
